...
tests upgrade-units ./internal/install TestLoadCandidateMirrorsInstallerVerification TestUpgradeOrdersConfirmedEffectsAndPreservesInstalledAt TestUpgradeInterruptionAfterBinaryIsPartialAndResumable TestUpgradeRefusalsHaveZeroEffects
