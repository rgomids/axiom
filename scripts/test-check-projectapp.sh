...
printf 'PASS: application checker accepts inward domain dependency; rejects eleven ambient I/O, outward dependency and bypass fixtures without executing them\n'
