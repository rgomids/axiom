...
- [ADR-0007 — Local publication and recovery protocol](0007-local-publication-and-recovery-protocol.md) — **Proposed — ready for human review**; shared logical publication states, coordination, commit truth, prior/new generations and fail-closed recovery under ADR-0005.
- [ADR-0008 — Minimal machine-local Execution record](0008-minimal-machine-local-execution-record.md) — **Proposed — ready for human review**; bounded sequential workflow authority, revisioned transitions, resume and cross-boundary correlation without defining a general Execution graph.
...
| Execution and Evidence model | Broad model remains open. ADR-0006 resolves detail-artifact ownership/correlation; ADR-0008 separately proposes the minimum machine-local record required by the Specification 004 sequential workflow. | ADR-0008 is Proposed because identity, authority, transitions, projection and Evidence correlation are durable/cross-cutting. General graph/orchestration semantics remain undecided. |
...
| Local publication and recovery protocol | Specification 004 Plan proposes shared coordination, private preparation, protected publication, commit-point, prior/new generation and reader/recovery semantics across mutable local stores. | ADR-0007 is Proposed. It consumes ADR-0005 without turning syscalls, filenames, layouts, libraries or Go packages into architecture. |
