...
- [ADR-0009 — Parent/child Execution Graph](0009-parent-child-execution-graph.md) — **Proposed, 2026-09-26**; revisioned DAG, lineage, authority, isolation, integration, structured coordination and cross-Runtime Evidence. Human acceptance required before implementation.
...
| Execution and Evidence model | ADR-0006 resolves detail-artifact ownership/correlation; ADR-0008 remains the accepted sequential/historical contract. Issue #97 now requires parent/child DAG semantics, proposed in ADR-0009. | ADR-0009 is Proposed because graph lineage, authority, dependencies, integration, cancellation/retry, coordination and Evidence are durable/cross-cutting. Explicit human acceptance remains pending. |
